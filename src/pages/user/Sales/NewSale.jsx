        ...
        <div className="mt-2 col-span-2 p-2">
          ...
          <div className="mb-4 flex justify-around md:justify-between ">
            ...
            <div className="text-gray-700 text-xs md:text-sm mr-10">
              <p className="text-green-500 text-[9px] pl-3 md:no-wrap  md:text-xs fw-bolder">
                {" "}
                <span className="text-gray-800 md:text-xs fw-bolder">
                  Available Items:{" "}
                </span>{" "}
          ...
          {loadingProducts ? (
            ...
            <>
              ...
              ${
                ...
                <div className="flex flex-col items-center justify-center py-12 px-6 bg-white rounded-2xl border-2 border-dashed border-gray-200 shadow-sm transition-all duration-300">
                  <div className="relative mb-6">
                    <div className="absolute inset-0 bg-blue-100 rounded-full blur-xl opacity-50 animate-pulse"></div>
                    <div className="relative p-5 bg-blue-50 rounded-full border-4 border-white shadow-sm">
          ...
          <div className="bg-white rounded-lg shadow-xl w-[350px] p-6 print-area font-mono text-gray-800">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-6">
              ...
              <button
                ...
                onClick={() => {
                  (setShowInvoiceModal(false), setProcessingSale("Process"));
                }}
