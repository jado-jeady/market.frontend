...
const AllSales = () => {
  ...
  const openReturnModal = (sale) => setSelectedSale(sale);
  const closeReturnModal = () => setSelectedSale(null);
  ...
  return (
    <div className="p-6 py-0">
      ...
      <div className="mb-3">
        ...
        <p className="text-sm text-gray-600">Sales you personally handled</p>
      </div>
  ...
  lg:bg-black/30 lg:backdrop-blur-xs lg:text-gray-700
  "
        >
          <div className="bg-white rounded p-6 w-11/12 md:w-2/3 max-h-[90vh] overflow-auto relative">
            ...
            <p className="mb-2">
              Cashier: {selectedSale.user?.full_name || "N/A"}
            </p>
            <p className="mb-2">
            ...
            <table className="w-full text-sm mt-4 border-collapse border border-gray-200">
              ...
              <tbody>
                ...
                <tr className="font-bold text-right">
                  <td colSpan="3" className="border text-left px-2 py-1">
                    Total
                  </td>
                  <td className="border px-2 py-1">
