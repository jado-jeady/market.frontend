 ...
 */}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gray-600 md:bg-gray-600 bg-gray-600 text-gray-600 py-3 rounded-lg font-semibold hover:bg-gray-800 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
