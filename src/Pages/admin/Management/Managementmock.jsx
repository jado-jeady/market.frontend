    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="bg-gradient-to-r from-secondary-600 to-primary-600 text-gray-500 px-6 py-2 rounded-lg hover:from-secondary-700 hover:to-primary-700 transition"
        >
          ...
          <form onSubmit={handleAddUser} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 text-gray-600 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
                required
              />
            </div>
            <div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 border text-gray-400 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-400 focus:ring-2 focus:ring-primary-500"
                required
              />
            </div>
            <div className="md:col-span-2">
              <button
                type="submit"
                className="bg-gray-300 text-gray-500 px-8 py-2 rounded-lg hover:bg-gray-400 btn-outline-info transition"
              >
                Create User
              </button>
            </div>
