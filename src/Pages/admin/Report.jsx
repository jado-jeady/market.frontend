  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h3 className="text-sm font-semibold text-gray-800 mb-6">Generate Report</h3>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          {/* Report Type Selection */}
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-3">Report Type</label>
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 text-gray-500 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                />
              </div>
              <div>
        ...
        <button
          ...
          className="bg-gradient-to-r from-gray-600 to-gray-700 text-white px-8 py-3 rounded-lg hover:from-gray-800 hover:to-gray-800 transition font-semibold"
        >
          Generate Report
        </button>
      </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {[
                ...
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-xs text-gray-500">{report.date}</td>
