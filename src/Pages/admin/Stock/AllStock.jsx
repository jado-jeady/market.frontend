      ...
      <div className="bg-white rounded-lg shadow-md p-4 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <input
            ...
            className="px-4 py-2 border border-gray-300 text-gray-600  text-xs rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
          />
          <select className="px-4 py-2 border text-xs border-gray-300 rounded-lg text-gray-600 focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none">
            <option>All Categories</option>
            <option>Electronics</option>
            <option>Clothing</option>
            <option>Food</option>
          </select>
          <select className="px-4 py-2 border text-gray-600 border-gray-300 text-xs  rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none">
            <option>All Stock Status</option>
            <option>In Stock</option>
            <option>Low Stock</option>
            <option>Out of Stock</option>
          </select>
          <button className="px-4 py-2 bg-gray-100 text-gray-700 text-xs  rounded-lg hover:bg-gray-200 transition">
            Apply Filters
          </button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="bg-gray-50 px-6 py-4 flex items-center justify-between border-t border-gray-200">
          ...
          <div className="flex space-x-2">
            ...
            <button className="px-4 py-2 bg-primary-600 text-gray-600 rounded-lg text-sm font-medium hover:bg-primary-700 transition">
              1
            </button>
            <button className="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100 transition">
              2
