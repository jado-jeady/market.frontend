...
const UserSidebar = () => {
  ...
  return (
    <div className="w-45 bg-gradient-to-b from-secondary-700 to-secondary-900 text-white min-h-screen fixed left-0 top-0 shadow-xl">
      {/* Logo */}
      <div className="p-3 border-b shadow-sm border-secondary-600">
        <div className="flex items-center space-x-3">
          <div className="w-25 h-20 bg-gray-300 rounded-lg flex p-0 items-center justify-center">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center space-x-2 px-4 py-3 text-sm rounded-lg transition-all duration-200 ${
                    isActive
                      ? ' text-white bg-gray-100 transform scale-105'
